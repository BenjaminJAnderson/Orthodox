...
def FNC_string (element, STR_start, STR_end, Angle, layer, width):
    STR_line = ""
    """
                      0          1         2    3          4           5
...
def FNC_polygon (element, STR_start, STR_end, Angle, layer, width):
    STR_line = ""
    """
                      0          1         2    3          4           5
    LIST_elmt = ["  ("," (start ",") (end ",") "," (layer ",") (width ","))"]
...
def FNC_spiral (cntr, radius, segs, startangle, tw, td, turns, spin, layer, net):
...
if __name__ == '__main__':
    ...
    Radius = 1.85 # start radius in mm
    Sides = 30.0
    ...
    print(FNC_spiral(Center, Radius, Sides, StartAngle, TrackWidth, TrackDistance, Turns, +1,"fcu",Net,),FNC_spiral(Center, Radius, Sides, StartAngle, TrackWidth, TrackDistance, Turns, -1,"bcu",Net,))
